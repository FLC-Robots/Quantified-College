...
wantedfeatures = np.array(['humidity', 'humidity_a', 'humidity_b', 'temperature','temperature_a', 'temperature_b', 'pressure', 'pressure_a', 'pressure_b'], dtype='<U12')
...
# Compare the arrays and create a new array with the words not in wanted_features
unwanted_features = np.array([feature for feature in allfeatures if feature not in wantedfeatures])
